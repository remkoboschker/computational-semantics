model([c1,c2,c3,b1,r1,f1,l1,bp1,n1,n2],
	[f(1,n_child_1,[c1,c2,c3]),
	 ...
	 f(1,n_biome_1,[f1]),
	 f(1,n_land_4,[f1]),
	 f(1,n_community_6,[f1]),
	 f(1,n_laundry_1,[l1]),
	 f(1,n_garment_1,[l1]),
	 f(1,n_white_goods_2,[l1]),
	 f(1,n_drygoods_1,[l1]),
	 ...
	 f(1,n_causal_agent_1,[c1,c2,c3]),
	 f(1,n_organism_1,[c1,c2,c3]),
	 f(1,n_living_thing_1,[c1,c2,c3]),
	 f(1,n_clothing_1,[l1]),
	 f(1,n_consumer_goods_1,[l1]),
	 f(1,n_covering_2,[l1]),
	 f(1,n_commodity_1,[l1]),
	 ...
	 f(1,n_vehicle_1,[b1]),
	 f(1,n_conveyance_3,[b1]),
	 f(1,n_instrumentality_3,[b1,bp1,n1,n2]),
	 f(1,n_artifact_1,[b1,bp1,l1,n1,n2,r1]),
	 f(1,n_whole_2,[b1,bp1,c1,c2,c3,l1,n1,n2,r1]),
	 f(1,n_object_1,[b1,bp1,c1,c2,c3,f1,l1,n1,n2,r1]),
	 f(1,n_physical_entity_1,[b1,bp1,c1,c2,c3,f1,l1,n1,n2,r1]),
